...
public class SyncHardwareInfoSchedulerJob extends QuartzJobBean {

    private static final LogEntityFactory logFactory = new LogEntityFactory(SyncHardwareInfoSchedulerJob.class, ServiceRole.SCHEDULER.name());
    ...
    protected void executeInternal(JobExecutionContext ctx) throws JobExecutionException {
        ...
        this.loggerService.info(SyncHardwareInfoSchedulerJob.logFactory.product()
                .how(LogHow.SCHEDULE).what(String.format("schedule sync [area: %s] hardware", areaKey)).build());
